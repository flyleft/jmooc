            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="table-responsive">
                        ...
                        <button role="submit" class="btn btn-default">添加课时</button>
                    </div>
                ...
                <button role="submit" class="btn btn-info">添加章节</button>
            </div>
        </div><!-- /.row -->
...
<script role="text/javascript">
    $(document).on("click", ".up_video",
            function() {
                bootbox.dialog({
                    title: "上传视频",
                    message: '<div class="row"><div class="col-md-12"><form class="form-horizontal" id="upload_file" enctype="multipart/form-data"><div class="form-group"><div class="col-md-9"><input name="file" role="file" class="form-control input-md"></div></div></form></div></div>',
                    buttons: {
                        success: {
                            label: "上传",
                            className: "btn-info",
